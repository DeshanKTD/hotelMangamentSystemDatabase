<?php
    ...
    $db = mysql_select_db("HOTEL", $server); 
                                    ...
                                    $query = mysql_query("select a.roomType, a.rAmount,
(select count(b.roomNo) from YDate 
as b inner join Room as c on b.roomNo=c.roomNo
inner join RoomType as d on c.roomTin=d.roomIndex 
where b.dates=now() and a.roomType = d.roomType) as Count
 from  RoomType as a;");
    $start = 'today';
            ...
            <div id="wrapper">
                ...
                <div id="page-wrapper">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="page-header">Check Total Room Availability</h1>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-12">
                                <form role="form" id="roomavialble" action="" method="post">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-1"><label> Date</label></div>
                                            <div class="col-lg-3"><input class="form-control" name="start"></div>
                                            <div class="col-lg-2"><input type="submit" class="btn btn-default" value="Search" name="search"/>
                                        </div>    
                                    </div>
                                </form>
                            </div>
...
as b inner join Room as c on b.roomNo=c.roomNo
inner join RoomType as d on c.roomTin=d.roomIndex 
where b.dates=$start and a.roomType = d.roomType) as Count
 from  RoomType as a;");
                            }
