                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="panel panel-success">
                                    <div class="panel-heading">
                                          <a href="javascript:;" data-toggle="collapse" data-target="#addadmin">
                                              <h4 class="panel-title">Add an Admin</h4></a>
                                    </div>
                                    
                                    <div class="panel-body collapse" id="addadmin">
                                        <form role="form" action="" method="post">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input class="form-control" name="alName">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input class="form-control" name="aUsername">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <input type="submit" class="btn btn-success" value="Add" name="aAdmin">
                                                </div>
                                            </div>
                                        ...
                                        <?php
                                            if(isset($_POST['aAdmin'])){
                                                ...
                                                $adamin = mysql_query("insert into Admin values ('$aUsername','$afName','$alName','$aPass')",$server);
                                            }
                                ...
                                <div class="panel panel-warning">
                                    <div class="panel-heading">
                                          <a href="javascript:;" data-toggle="collapse" data-target="#editadmin">
                                              <h4 class="panel-title">Edit an Admin</h4></a>
                                    </div>
                                    
                                    <div class="panel-body collapse" id="editadmin">
                                        <form role="form" action="" method="post">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-lg-4">Username</div>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-lg-4">First Name</div>
                                                    <div class="col-lg-8">
                                                        <input class="form-control" name="efName">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <?php
                                            if(isset($_POST['change'])){
                                                ...
                                                if(!empty($efName)){
                                                    $upd = mysql_query("update Admin set adFName='$efName' where adminID='$eUsrname'",$server);
                                                }
                                                if(!empty($elName)){
                                                    $upd = mysql_query("update Admin set adLName='$elName' where adminID='$eUsrname'",$server);
                                                }
                                                if(!empty($epass)){
                                                    $upd = mysql_query("update Admin set adPwd='$epass' where adminID='$eUsrname'",$server);
                                                }
                                            ...
                                            elseif (isset($_POST['remove'])) {
                                                # code...
                                                 ...
                                                 mysql_query("delete from Admin where adminID='$eUsrname'",$server);
                                            }
                                    ...
                                    <div class="col-lg-8">
                                        <table class="table table-bordered table-hover table-stripped">
                                            <thead>
                                                ...
                                                <?php
                                                    $data = mysql_query("select adminID,concat_ws(' ',adFName,adLName) as Name from Admin",$server);
